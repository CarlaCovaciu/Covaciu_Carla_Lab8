...
namespace Covaciu_Carla_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Covaciu_Carla_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Covaciu_Carla_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
